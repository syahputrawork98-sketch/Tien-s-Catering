...
Sistem kerja TC dirancang untuk keamanan, konsistensi, dan keteraturan.
...
Sistem kerja ini disesuaikan dengan kebutuhan project TC. File seperti `README.md` dan `FITUR.md` wajib mencerminkan project nyata.
...
### Aturan Adaptasi FITUR.md
FITUR project turunan sebaiknya berisi daftar fitur nyata:
...
- README/FITUR belum disesuaikan setelah project berubah.
...
* `PROJECT_STARTER_CHECKLIST.md` digunakan saat TC mulai dipakai untuk project nyata.
...
- **Gemini 3.5 Flash** (Model default untuk eksekusi umum dan cepat)
- **Gemini 3.1 Pro** (Model cadangan untuk analisis mendalam dan risiko tinggi)

## Fungsi Dokumen Area (Discovery-First)
TC-Tien-s-Catering menggunakan pendekatan **Discovery-First Documentation**. Area docs mencatat apa yang ditemukan dari aplikasi lama, bukan memaksakan struktur baru.
