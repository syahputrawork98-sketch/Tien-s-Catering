...
4. Mengecek hasil batch terhadap status di `Docs/history` menggunakan pelacakan F-number (F00 sampai F34).
5. Membaca detail feature file di `Docs/history/features`.
6. Memahami bahwa review bersifat risk-based, tidak wajib setiap batch, hanya jika diminta Roomchat 00/user.
