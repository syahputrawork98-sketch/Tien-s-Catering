...
| **F09** | Customer Dashboard Home | Found | `apps/src/routes/dashboard/+page.svelte`, `apps/src/routes/dashboard/+layout.svelte` | `features/F09_customer_dashboard_home.md` | Halaman utama dashboard customer, navigation sidebar, stats widgets, latest order card, dan shortcut cards |
